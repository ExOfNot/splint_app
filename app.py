...
st.set_page_config(
    page_title="Комплексный план лечения - Сплинттерапия",
    page_icon="🦷",
    layout="wide"
)
...
st.title("🦷 Комплексный план лечения - Сплинттерапия")
st.markdown("---")
...
st.info("Заполните желтые поля, используйте чекбоксы и селекторы")
